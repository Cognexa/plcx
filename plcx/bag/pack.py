...
from plcx.utils.boolean import find_boolean_format, to_byte
...
def to_bytes(format_: str, *args) -> bytes:
    ...
    :param format_: format of message
    ...
    arguments = (to_byte(arg) if i in indexes else arg for i, arg in enumerate(args))
    # convert args to bytes
