...
from plcx.utils.boolean import byte_to_booleans, BOOLEAN_FORMAT_SYMBOL, BIT_ORDER
...
def bytes_to_dict(
    ...
    values = bytes_to_list(msg=msg, format_=''.join([f for _, f in config]), byte_order=byte_order, bit_order=bit_order)
