...
@pytest.mark.parametrize("one_byte, bit_order, exp", [
    ...
    (int("10100001", 2).to_bytes(1, "little"), "MSB", [True, False, False, False, False, True, False, True]),
    (int("10000011", 2).to_bytes(1, "little"), "MSB", [True, True, False, False, False, False, False, True]),
])
...
@pytest.mark.parametrize("boolean_list, bit_order, exp", [
    ...
    (([True], [True], ), "MSB", int("0000000100000001", 2).to_bytes(2, "little")),
    ([True, False, True], "MSB", int("00000101", 2).to_bytes(1, "little")),
])
