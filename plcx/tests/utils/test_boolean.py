...
from plcx.utils.boolean import to_boolean_list
...
def test_byte_to_boolean_list(one_byte, exp):
    """
    ...
    """
    assert to_boolean_list(one_byte) == exp


def test_byte_to_boolean_list_error():
    """
    Test raise error.
    """
    with pytest.raises(TypeError):
        to_boolean_list(int("10100001""10100001", 2).to_bytes(2, 'little'))
